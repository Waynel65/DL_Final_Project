...
# kaldi_scripts/extract_features_kaldi.sh
...
## wayne's version
DATA_ROOT=$1 # /path/to/L1-ARCTIC/BDL

KALDI_ROOT=/home/jb7410/ppg2ppg/kaldi
PRETRAIN_ROOT=/home/jb7410/ppg2ppg/pretrained_models/pretrained_model
AM_ROOT=$PRETRAIN_ROOT/exp/chain_cleaned/tdnn_1d_sp
IE_ROOT=$PRETRAIN_ROOT/exp/nnet3_cleaned/extractor
LANG_CHAIN_ROOT=$PRETRAIN_ROOT/data/lang_test_tgsmall
# LANG_TGLARGE_ROOT=$PRETRAIN_ROOT/data/lang_test_tglarge
BNF_NODE=prefinal-chain.linear
SCRIPT_ROOT=/home/jb7410/ppg2ppg/wayne_kaldi_script
# KALDI_s5=$KALDI_ROOT/egs/yesno/s5
