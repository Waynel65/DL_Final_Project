...
## wayne: this file is basically same as the translator_train.py
...
def main():
    ...
    for epoch in range(hp.epochs):
        ...
        for i, data in enumerate(pbar):
            ...
            mel_loss = nn.L1Loss()(mel_pred, mel) #.to(device)
            post_mel_loss = nn.L1Loss()(postnet_pred, mel) #.to(device)
